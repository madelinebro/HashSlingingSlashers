...
(2, '2025-10-23', 'Transfer', 9000, 'from saving to checking', 'shopping', 'MO'),
(3, '2025-10-25', 'Deposit', 800, 'ATM BOA', 'Shopping', 'MO'),
(2, '2025-10-23', 'Transfer', 10000, 'from saving to checking', 'shopping', 'MO'),
...
(2, '2025-10-25', 'Deposit', 412.30, 'Cash Deposit', 'Entertainment', 'CA'),
...
(1, '2025-10-05', 'Deposit', 143.30, 'Refund Deposit', 'Groceries', 'CA'),
...
-- =========================
-- BACKFILL USER_ID ON TRANSACTIONS
-- =========================

ALTER TABLE public.transactions
ADD COLUMN IF NOT EXISTS user_id INT REFERENCES public.users(user_id) ON DELETE CASCADE;
